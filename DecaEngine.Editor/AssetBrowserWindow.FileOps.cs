...
{
	/// <summary>Операции над файлами: тулбар, хлебные крошки, контекстное меню, переименование, удаление, вставка, создание префаба. Часть <see cref="AssetBrowserWindow"/> - файл на тему;
