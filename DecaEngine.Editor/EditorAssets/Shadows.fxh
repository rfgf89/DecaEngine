                                     ...
                                     float3 ShadowUVDepthDY)
{
    ...
    float Det = (ShadowUVDepthDX.x * ShadowUVDepthDY.y) - (ShadowUVDepthDX.y * ShadowUVDepthDX.x);
                          ...
                          in CascadeSamplingInfo    SamplingInfo)
{
    ...
    return tex2DShadowMap.SampleCmp(tex2DShadowMap_sampler, float3(SamplingInfo.f2UV, SamplingInfo.iCascadeIdx), SamplingInfo.fDepth);
}
